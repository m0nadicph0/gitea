...
- [ ] `GET /repos/{owner}/{repo}/commits/{ref}/status` Get a commits combined status, by branch/tag/commit reference
- [ ] `GET /repos/{owner}/{repo}/commits/{ref}/statuses` Get a commits statuses, by branch/tag/commit reference
...
- [ ] `GET /repos/{owner}/{repo}/git/commits/{sha}.{diffType}` Get a commits diff or patch
